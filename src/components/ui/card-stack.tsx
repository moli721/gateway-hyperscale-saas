  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-[#50A2FF]/5 blur-3xl"
          aria-hidden="true"
        />
        <div
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border-4 border-white/5 overflow-hidden shadow-xl",
  ...
  return (
    <div className="relative h-full w-full bg-black">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6">
        {item.icon && (
          <span className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-white/5">
            <item.icon className="h-6 w-6 text-[#A48E68] opacity-90" />
          </span>
        )}
